...
np.save('best_lambda_phase.npy', p)
...
fig.tight_layout(); fig.savefig('fig_lambda_phase.png', dpi=130, bbox_inches='tight')
pr('wrote fig_lambda_phase.png, best_lambda_phase.npy')
