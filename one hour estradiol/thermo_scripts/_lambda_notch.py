...
np.save('best_lambda_notch.npy', p)
...
fig.tight_layout(); fig.savefig('fig_lambda_notch.png', dpi=130, bbox_inches='tight')
pr('wrote fig_lambda_notch.png, best_lambda_notch.npy')
